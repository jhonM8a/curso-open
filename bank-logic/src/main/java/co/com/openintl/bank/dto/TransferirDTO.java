...
public class TransferirDTO {
	...
	public TransferirDTO(@NotEmpty @NotNull @Size(min = 19, max = 19) String cuenIdOrigen,
			@NotEmpty @NotNull @Size(min = 19, max = 19) String cuenIdDestino,
			@NotEmpty @NotNull @Positive BigDecimal valor, @NotNull @Size(min = 5, max = 50) String usuUsuario) {
		super();
